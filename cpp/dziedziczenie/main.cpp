...
//dziedziczenie - prostopadloscian
...
public:
    ...
    int pole(void)
    {
        return 2*Prostokat::pole()+obwod()*h;
    }
    ...
    void info (void)
    {
        cout << "prostokat: a=" << a << " b=" << b << "h=" << h << endl;
        cout << "pole=" << pole() << " objetosc=" << objetosc() << " obwod=" << obwod() << endl;
    }
};
//dziedziczenie - kolo
class Kolo
